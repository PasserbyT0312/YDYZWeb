...
.lottoryBox .container .el-carousel--vertical {
...
.lottoryBox .noticeTitle {
  color: #ff9797;
  border: 1px solid #ff9797;
  width: 83px;
  text-align: center;
}
.lottoryBox .container .el-carousel__indicators--vertical {
  display: none;
}
.lottoryBox .middleBox {
  display: flex;
  align-items: flex-start;
  flex-wrap: wrap;
  margin-bottom: 11px;
}
.lottoryBox .banner img {
  height: 100%;
  width: 100%;
}
.lottoryBox .itemGame {
...
.lottoryBox .itemGame img {
  width: 100%;
  height: 250px;
}
.lottoryBox .itemTitle {
  text-align: center;
  font-size: 16px;
  color: #706244;
  transition: 0.5s;
...
.lottoryBox .itemGame:hover {
  background: #706244;
}
.lottoryBox .itemGame:hover .locked {
  background: #fff;
  color: #706244;
}
.lottoryBox .itemGame:hover .itemTitle {
  color: #fff;
}
/*弹出框*/
